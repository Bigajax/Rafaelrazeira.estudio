/* ============================================================
   ...
   Em 11/09/2026 este código saiu de middleware.ts para cá, sem mudança,
   porque o middleware passou a ter um segundo trabalho (idioma) nas URLs
   públicas. O despachante em middleware.ts garante que este ramo, e o
   cliente do Supabase que ele constrói, só rodam em /crm.
   ============================================================ */
...
export async function middlewareCrm(request: NextRequest) {
