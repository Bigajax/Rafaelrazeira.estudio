...
export const PROPOSTAS: Record<string, Proposta> = {
  ...
  /* A Arena disse que fecha no cartão, e o saldo no cartão carrega a
     taxa: R$ 880 em 4x de R$ 220 (uns 10% sobre os R$ 800 do Pix, o
     que o Mercado Pago cobra para 4 parcelas sem juros ao comprador).
     Para o cliente ver "4x de R$ 220" iguais, a conta do MP precisa
     estar com parcelamento sem juros até 4x; senão o checkout soma o
     juro do comprador por cima. Entrada 200 e saldo Pix 799 fecham os
     mesmos R$ 999 das outras propostas. */
  "arena-imports": {
    ...
    itens: {
      ...
      saldo_card: { label: "Saldo na entrega, no cartão em 4x (taxa inclusa)", valor: 880, metodo: "card", maxParcelas: 4 },
    },
  },
  "ortobom-aracaju": {
